module.exports = async ({github, context, core}) => {
  ...
  try {
    ...
    issue_number = parseInt(prNumberContent, 10);
    ...
    if (issue_number === 0) {
      console.log("PR number is 0 (workflow_dispatch), skipping comment posting.");
      return;
    }
  } catch (error) {
    core.setFailed(`Failed to read or parse 'pr_number.txt': ${error.message}`);
    return;
  }
